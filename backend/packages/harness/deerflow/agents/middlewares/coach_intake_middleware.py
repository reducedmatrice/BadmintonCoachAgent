    ...
    def classify(message: str) -> Mapping[str, Any] | None:
        ...
        system = SystemMessage(
            content=(
                ...
                "prematch, postmatch, health, check_memory, chitchat, or fallback. "
                ...
                "Use chitchat for simple greetings, acknowledgements, thanks, laughter, numeric option replies, or casual chat "
                "that should not trigger coach skills. "
